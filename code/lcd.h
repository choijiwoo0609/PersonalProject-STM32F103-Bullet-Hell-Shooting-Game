...
extern void Lcd_Draw_Triangle(int x1, int y1, int x2, int y2, int x3, int y3, unsigned short Color);
extern void Lcd_Draw_Line(int x1, int y1, int x2, int y2, unsigned short Color);